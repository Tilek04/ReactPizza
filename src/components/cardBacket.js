...
import { addItems, minusItems, removeItems } from "../Redux/slices/cardSlice";

function CardBacket({ id, title, imageUrl, type, price, count }) {
  const dispatch = useDispatch();
  const minusCount = count * price;
  const onClickPluse = () => {
    dispatch(
      addItems({
        id,
